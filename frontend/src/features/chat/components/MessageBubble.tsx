...
export function MessageBubble({ message, onShowSources }: MessageBubbleProps) {
  ...
  return (
    ...
    >
      {!isUser && (
        <div className="mt-0.5 h-20 aspect-[816/1283] shrink-0 overflow-hidden rounded-md border border-slate-200 bg-slate-100 shadow-[0_4px_12px_rgba(16,185,129,0.18)]">
